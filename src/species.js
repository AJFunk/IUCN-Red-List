  ...
  return {
    ...
    find: (options: Object = {}): Promise<any> =>
      new Promise((resolve: (data: Object) => void, reject: (reason: Error) => void): mixed => {
        ...
        let endpoint;
        if (options.region) {
          if (options.id) endpoint = `/species/id/${options.id}/region/${options.region}`;
          else endpoint = `/species/${options.name}/region/${options.region}`;
        } else {
          if (options.id) endpoint = `/species/id/${options.id}`;
    ...
    narrative: (options: Object = {}): Promise<any> =>
      new Promise((resolve: (data: Object) => void, reject: (reason: Error) => void): mixed => {
        ...
        let endpoint;
        if (options.region) {
          if (options.id) endpoint = `/species/narrative/${options.id}/region/${options.region}`;
          else endpoint = `/species/narrative/${options.name}/region/${options.region}`;
        } else {
          if (options.id) endpoint = `/species/narrative/${options.id}`;
    ...
    countries: (options: Object = {}): Promise<any> =>
      new Promise((resolve: (data: Object) => void, reject: (reason: Error) => void): mixed => {
        ...
        let endpoint;
        if (options.region) {
          if (options.id) endpoint = `/species/countries/id/${options.id}/region/${options.region}`;
          else endpoint = `/species/countries/name/${options.name}/region/${options.region}`;
        } else {
          if (options.id) endpoint = `/species/countries/id/${options.id}`;
    ...
    historical: (options: Object = {}): Promise<any> =>
      new Promise((resolve: (data: Object) => void, reject: (reason: Error) => void): mixed => {
        ...
        let endpoint;
        if (options.region) {
          if (options.id) endpoint = `/species/history/id/${options.id}/region/${options.region}`;
          else endpoint = `/species/history/name/${options.name}/region/${options.region}`;
        } else {
          if (options.id) endpoint = `/species/history/id/${options.id}`;
